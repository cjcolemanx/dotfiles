...
local maps = require("keymaps.plugin.telescope").keymap(actions)

telescope.setup({
  defaults = {
    mappings = maps.defaults.mappings,
    sorting_strategy = "descending", -- descending ascending
    selection_strategy = "closest", -- reset (default) follow row closest none
...
-- Add keybinds
require("keymaps.plugin.telescope").binds(builtin, utils, previewers)
